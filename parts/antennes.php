<!-- Le carousselle de toutes les antennes -->
<?php
  ...
  <div class="swiper-wrapper">
    ...
    <div class="swiper-slide">
      <div class="card card-body">
        ...
        <a href="<?= $antenne_1['link']['url'] ?>" class="esp">
    ...
    <div class="swiper-slide">
      <div class="card card-body">
        ...
        <a href="<?= $antenne_2['link']['url'] ?>" class="esp">
    ...
    <div class="swiper-slide">
      <div class="card card-body">
        ...
        <a href="<?= $antenne_3['link']['url'] ?>" class="esp">
    ...
    <div class="swiper-slide">
      <div class="card card-body">
        ...
        <a href="<?= $antenne_4['link']['url'] ?>" class="esp">
    ...
    <div class="swiper-slide">
      <div class="card card-body">
        ...
        <a href="<?= $antenne_5['link']['url'] ?>" class="esp">
    ...
    <div class="swiper-slide">
      <div class="card card-body">
        ...
        <a href="<?= $antenne_6['link']['url'] ?>" class="esp">
